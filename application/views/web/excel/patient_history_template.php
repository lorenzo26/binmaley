...
<body>
	...
	<table border="1px" cellspacing = 0>
			...
			<tr style="font-weight: bold;font-size: 20px;">
				<td colspan="2"><?php print_r($patient['firstname'] . " ".$patient['middlename']." ".$patient['lastname'])?></td>
				<td><?=$patient['gender']?></td>
			</tr>
			<tr style="font-weight: bold;font-size: 20px;">
				<td colspan="2">Birthdate: <?=($patient['birthdate'])?></td>
				<td><?=$patient['civilstatus']?></td>
			</tr>
			<tr style="font-weight: bold;font-size: 20px;">
				<td colspan="3">Address: <?=$patient['address']?></td>
			</tr>
			<tr style="font-weight: bold;font-size: 20px;">
				<td colspan="3">Contact No.: <?=$patient['contact_number']?></td>
			</tr>
		<?php if(!empty($header)):?>
