 <div class="content-wrapper">
    <div class="row">
                  ...
                  <div class="clearfix">
                    <div class="float-left">
                      <h4 class="text-primary">
                       <img src="<?=base_url()?>assets/images/icons/pap_report.png" alt="" width="70px">
                      </h4>
                    </div>
                    <div class="float-right">
                      <p class="card-text text-dark">PAP SMEAR</p>
                      <h4 class="bold-text" style="text-align: right;"><?=$pap_smear?></h4>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="clearfix">
                    <div class="float-left">
                      <h4 class="text-primary">
                       <img src="<?=base_url()?>assets/images/icons/pnc_report.png" alt="" width="70px">
                      </h4>
                    </div>
                    <div class="float-right">
                      <p class="card-text text-dark">PNC</p>
                      <h4 class="bold-text" style="text-align: right;"><?=$pnc?></h4>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="clearfix">
                    <div class="float-left">
                      <h4 class="text-warning">
                        <img src="<?=base_url()?>assets/images/icons/ultra_report.png" alt="" width="70px">
                      </h4>
                    </div>
                    <div class="float-right">
                      <p class="card-text text-dark">Ultrasound</p>
                      <h4 class="bold-text" style="text-align: right;"><?=$ultrasound?></h4>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            <div style="width: 100%">
                <div class="pull-right"><a href="<?=base_url()?>export_excel/export_report_midwife" class="btn btn-success add-btn" ><i class="fa fa-file-excel-o"></i> Export</a></div>
                <h3>Prenatal Patients <small>(<?=date('M'). ' ' . date('Y')?>)</small></h3>
            </div>
            <br><br>
            <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                  ...
                  <!-- <img src="<?=base_url()?>assets/images/icons/dentist_icon.png" alt="" width="15%" style="position: absolute; opacity: .3;  top: 0;"> -->
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="view_patient">
                  ...
                  <div class="mod_cont">
                    <div><h6 class="mod_cont_label">Midwife</h6></div>
                    <div class="col_2">
                      <div>
                        Pregnancy Stage: <span>{{ modal_content.pregnancy_stage ? modal_content.pregnancy_stage : 'No Record' }}</span>
                      </div>
                      <div>
                        Child Count: <span>{{ modal_content.child_count ? modal_content.child_count : 'No Record'  }}</span>
                      </div>
                    </div>
                  </div>
                  <div class="mod_cont">
