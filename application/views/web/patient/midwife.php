 <div class="content-wrapper">
    <div>
        <div class="pull-right"><a href="<?=base_url()?>patient/add/null/midwife" class="btn btn-success add-btn"><i class="fa fa-plus"></i> Patient</a></div>
        ...
        <h1>Patients <small>Prenatal</small></h1>
    </div>
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                            ...
                            <td>
                                <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="<?=base_url().'patient/add/'.$patients['patientid'] ?>/midwife"><i class="fa fa-edit"></i> Add Complaint</a>
                                  </div>
                                </div>
                            </td>
                        </tr>
